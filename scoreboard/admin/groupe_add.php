<?php
	...
	if(isset($_POST['submit']))
	{
		if(isset($_POST['groupe']) && !empty($_POST['groupe']))
		{
			...
			if ($groupe != NULL)
			{
				$req_add = $bdd->prepare('INSERT INTO groupe(nom) VALUES(:groupe)');
		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li class="current"><a href="#"><i class="glyphicon glyphicon-plus"></i> Ajouter un Groupe</a></li>
                    <li><a href="users_add.php"><i class="	glyphicon glyphicon-plus"></i> Ajouter un utilisateur</a></li>
                    <li class="current"><a href="config_admin.php"><i class="glyphicon glyphicon-cog"></i> Configuration du site</a></li>
		  		...
		  		<div class="col-md-12">
		  			<div class="content-box-large">
		  				<div class="panel-heading">
							<div class="panel-title"><b>Ajouter un Groupe</b></div>
						</div>
						<form action="groupe_add.php" method="post">
			  				<div class="panel-body">
			  					<div class="form-group">
									...
									<?php
										...
										<div class="well">
											<h3><?php echo $groupe; ?> bien ajouté !</h3>
										</div>

									<?php
										}
									?>
										<label class="col-md-2 control-label" for="text-field">Entrez un nom de groupe</label>
										<input class="form-control" placeholder="Entrez un nom de groupe..." type="text" name="groupe">
										<br>
