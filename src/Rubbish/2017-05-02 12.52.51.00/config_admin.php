		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li class="current"><a href="users_add"><i class="	glyphicon glyphicon-plus"></i> Ajouter un utilisateur</a></li>
						...
						<form action="users_add" method="post">
			  				<div class="panel-body">
			  					<div class="form-group">
									...
									<input class="form-control" placeholder="Entrez un nom..." type="text" name="nom">
									<br>
									<label class="col-md-2 control-label" for="text-field">Lien de l'image (/!\ Attention vous devez héberger votre image sur NoelShark ou imgur /!\</label>
									<input class="form-control" placeholder="Entrez un prenom..." type="text" name="prenom">
									<br>
									<input class="btn btn-primary signup" type="submit" name="submit" value="Ajouter">
								</div>
