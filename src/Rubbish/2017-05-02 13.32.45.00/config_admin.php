		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li class="current"><a href="users_add"><i class="glyphicon glyphicon-cog"></i> Configuration du site</a></li>
			  				...
			  				<div class="panel-body">
			  					<div class="form-group">
									...
									?>
										...
										<br>
										<input class="btn btn-danger signup" type="submit" name="submit" value="Supprimer">
									</div>
								</div>
			                </div>
			            </form>  
			  				...
			  				<div class="panel-body" >
			  					<div class="form-group">
									...
									<label class="form-check-label">
									    <input class="form-check-input" type="checkbox" value="flocon">
									...
									<br>
									<label class="form-check-label">
									    <input class="form-check-input" type="checkbox" value="last_points">
									    Derniers points ajoutés
									</label>
									<br>
									<label class="form-check-label">
									    <input class="form-check-input" type="checkbox" value="view_group">
									...
									<br>
									<br>
									<input class="btn btn-primary signup" type="submit" name="submit" value="Mettre à jour le site">
								</div>
			                </div>
			            </form>  
		  			</div>
						...
						<form action="users_add" method="post">
			  				<div class="panel-body">
			  					<div class="form-group">
									...
									<br>
									<label class="form-check-label">
									    <input class="form-check-input" type="radio" value="last_points">
									    Supprimer points
									</label>
									<br>
									<label class="form-check-label">
									    <input class="form-check-input" type="radio" value="view_group">
									    Supprimer utilisateurs + points
									</label>
									<br>
									<br>
									<input class="btn btn-primary signup" type="submit" name="submit" value="Mettre à jour le site">
